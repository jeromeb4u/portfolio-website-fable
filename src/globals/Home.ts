      ...
      fields: [
        {
          ...
          type: 'text',
          localized: true,
          admin: { description: 'Disciplines line under the location, e.g. "Frontend Engineer · React & Next.js · …"' },
        },
        {
          name: 'headingLine1',
          type: 'text',
          required: true,
          localized: true,
          admin: { description: 'First name — the hero heading is the name, set huge, over two lines' },
        },
        { name: 'headingLine2', type: 'text', localized: true, admin: { description: 'Surname' } },
        {
          name: 'subheading',
          type: 'textarea',
          localized: true,
          admin: { description: 'Lead line, one sentence, set large' },
        },
        {
          name: 'body',
          type: 'textarea',
          localized: true,
          admin: { description: 'Supporting paragraph under the lead, set small' },
        },
